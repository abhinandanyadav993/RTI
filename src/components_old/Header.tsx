...
// const Header = () => {
//   const [userName] = useState("John Doe"); // Example username
...
//           >
//             <Menu.Items className="absolute right-0 mt-2 w-48 bg-white divide-y divide-gray-100 rounded shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
//               <div className="p-2">
//                 <Menu.Item>
//                   {({ active }) => (
//                     <button
      ...
      <div className="hidden lg:flex lg:gap-x-12">
        <div className="relative">
          {/* <button type="button" className="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" aria-expanded="false">
           ...
           <a href="#" className="text-sm/6 font-semibold text-gray-900">Create Lead</a>
        ...
        <a href="#" className="text-sm/6 font-semibold text-gray-900">Lead Status</a>
        <a href="#" className="text-sm/6 font-semibold text-gray-900">Lead Completed</a>
        <a href="#" className="text-sm/6 font-semibold text-gray-900">User Details</a>
      </div>
